...
const NAV_ITEMS = [
  { to: '/', label: 'Overview', icon: '◧', enabled: true },
  ...
  { to: '/analytics', label: 'Analytics', icon: '◫', enabled: true },
  { to: '/payments', label: 'Payment Monitoring', icon: '⌁', enabled: false },
  { to: '/platform-users', label: 'Platform Users', icon: '◐', enabled: true },
  { to: '/audit-logs', label: 'Audit Logs', icon: '☰', enabled: true },
  { to: '/system-health', label: 'System Health', icon: '♥', enabled: true },
] as const;
